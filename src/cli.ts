...
export function createCLI(): Command {
  ...
  program
    ...
    .option("--react-path <path>", "Require path for react-lua", "ReplicatedStorage.Packages.React")
    .option("--react-roblox-path <path>", "Require path for react-roblox", "ReplicatedStorage.Packages.ReactRoblox")
