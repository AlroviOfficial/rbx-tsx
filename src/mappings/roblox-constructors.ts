...
export const ROBLOX_STATIC_METHODS: Record<string, Set<string>> = {
  ...
  Vector2: new Set(["new"]),
  Vector3: new Set(["new"]),
  CFrame: new Set(["new", "fromEulerAnglesXYZ", "fromEulerAnglesYXZ", "lookAt", "fromAxisAngle", "fromOrientation", "fromMatrix", "identity"]),
  Instance: new Set(["new"]),
  TweenInfo: new Set(["new"]),
  Font: new Set(["new"]),
  BrickColor: new Set(["new", "random", "Red", "Blue", "Green", "Yellow", "White", "Black"]),
};
