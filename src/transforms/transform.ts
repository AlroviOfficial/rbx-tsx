...
export function transformSourceFile(
      ...
      bodyStatements.push(
        ts.factory.createVariableStatement(
          ...
          ts.factory.createVariableDeclarationList(
            [ts.factory.createVariableDeclaration(tempName, undefined, undefined, ea.expression)],
            ts.NodeFlags.Const,
          ),
        ),
      );
  ...
  if (ctx.needsReact || hasJSX(sourceFile)) {
    ...
    allStatements.push({
      type: "local",
      name: "React",
      value: call(ident("require"), [raw(buildRequirePath(ctx.options.reactPath))]),
    });
  ...
  if (ctx.needsReactRoblox) {
    allStatements.push({
      type: "local",
      name: "ReactRoblox",
      value: call(ident("require"), [raw(buildRequirePath(ctx.options.reactRobloxPath))]),
    });
  }
      ...
      return [{
        ...
        body: [
          { type: "local", name: "result", value: table([]) },
          {
            ...
            body: [
              { type: "local", name: "t", value: call(ident("select"), [ident("i"), { type: "varargs" }]) },
              {
                type: "if",
                condition: ident("t"),
                body: [{
      ...
      return [{
        ...
        body: [
          { type: "local", name: "keys", value: table([]) },
          {
            ...
            iterators: [ident("t")],
            body: [
              { type: "expression-statement", expr: call(index(ident("table"), "insert"), [ident("keys"), ident("k")]) },
            ],
          },
      ...
      return [{
        ...
        body: [
          { type: "local", name: "values", value: table([]) },
          {
            ...
            iterators: [ident("t")],
            body: [
              { type: "expression-statement", expr: call(index(ident("table"), "insert"), [ident("values"), ident("v")]) },
            ],
          },
        ...
        body: [
          { type: "local", name: "result", value: table([]) },
          {
            ...
            body: [
              ...
              {
                type: "if",
                condition: binary(call(ident("typeof"), [ident("t")]), "==", str("table")),
                body: [{
                  type: "for-in",
                  vars: ["_", "v"],
                  iterators: [ident("t")],
                ...
                elseBody: [{
                  type: "expression-statement",
                  expr: call(index(ident("table"), "insert"), [ident("result"), ident("t")]),
                }],
              },
            ],
          },
        ...
        body: [
          {
            ...
            body: [{
              type: "if",
              condition: unary("not", call(ident("fn"), [ident("v"), ident("i")])),
        ...
        body: [
          { type: "local", name: "acc", value: ident("init") },
          {
            ...
            body: [{
              type: "assignment",
              target: ident("acc"),
              value: call(ident("fn"), [ident("acc"), ident("v"), ident("i")]),
            }],
          },
        ...
        body: [
          {
            ...
            body: [{
              type: "if",
              condition: call(ident("fn"), [ident("v"), ident("i")]),
              body: [{ type: "return", value: binary(ident("i"), "-", num(1)) }],
            }],
          },
      ...
      return [{
        ...
        body: [
          { type: "local", name: "parts", value: table([]) },
          {
            ...
            body: [
              { type: "local", name: "v", value: call(ident("select"), [ident("i"), { type: "varargs" }]) },
              {
                type: "if",
                condition: binary(ident("v"), "and", binary(ident("v"), "~=", str(""))),
                body: [{
                  type: "expression-statement",
                  expr: call(index(ident("table"), "insert"), [ident("parts"), ident("v")]),
                }],
              },
            ],
          },
